...
mod tests {
    ...
    fn test_table_namespace_encoding() {
        ...
        let expected_bytes = vec![
            ...
            114, 39, 58, 32, 39, 124, 117, 49, 39, 44, 32, 39, 102, 111, 114, 
            116, 114, 97, 110, 95, 111, 114, 100, 101, 114, 39, 58, 32, 70, 
            97, 108, 115, 101, 44, 32, 39, 115, 104, 97, 112, 101, 39, 58, 32, 
            40, 50, 44, 32, 50, 41, 125, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 
    ...
    fn test_table_round_trip() {
        ...
        let decoded_value: ndarray::Array2<u8> = FromTableNs::from_table_ns(&mut std::io::Cursor::new(buf)).unwrap();
